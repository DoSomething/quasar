  ...
  create  table "quasar"."public"."first_and_second_signups__dbt_tmp"
  as (
...
FROM
    ...
    JOIN "quasar"."public"."campaign_info" c1 ON (ns1.campaign_id = c1.campaign_id :: text)
    LEFT JOIN "quasar"."public"."campaign_info" c2 ON (ns2.campaign_id = c2.campaign_id :: text)
    LEFT JOIN "quasar"."public"."user_rb_summary" r1 ON (ns1.signup_id = r1.signup_id)
    LEFT JOIN "quasar"."public"."user_rb_summary" r2 ON (ns2.signup_id = r2.signup_id)
WHERE
    ns1.nth_signup = 1
  );